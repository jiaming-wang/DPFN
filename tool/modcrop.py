...
class modcrop:
    ...
    def run(self, pan_img, ms_img, pixel):
        ...
        box = (pixel, pixel, pan_img.size[0] - pixel, pan_img.size[1] - pixel)
        ms_img.crop(box).save('/Users/wjmecho/Desktop/pan/1/8.tif')
        pan_img.crop(box).save('/Users/wjmecho/Desktop/pan/1/9.tif')

if __name__ == "__main__":

    ms_path = '/Users/wjmecho/Desktop/pan/8.tif'
    pan_path = '/Users/wjmecho/Desktop/pan/8.tif'
    app = modcrop(pan_path, ms_path, 63)